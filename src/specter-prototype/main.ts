...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  .register.waiting-room { background: rgba(138, 217, 196, 0.12); color: #b3e8d8; border: 1px solid #2c5547; }
  .register-flip {
    margin: 16px 0; padding: 12px 16px;
    border-left: 3px solid #b3e8d8; background: rgba(138, 217, 196, 0.05);
    font-size: 13.5px; overflow: hidden;
  }
  .ripple { width: 100%; height: 2px; margin-bottom: 8px; background: linear-gradient(90deg, transparent, #b3e8d8, transparent); animation: ripple 4s infinite ease-in-out; }
  @keyframes ripple {
  ...
  .btn.primary:hover:not(.disabled):not(:disabled) { background: #b3e8d8; }
