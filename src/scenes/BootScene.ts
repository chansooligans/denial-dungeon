...
const OBJECT_SOURCES: Record<string, string> = {
  // ===== Canonical hospital + waiting-room object textures =====
  //
  // Sources are now four themed sheets — `clinical_R_C` (yellow),
  // `facilities_R_C` (magenta), `admin_R_C` (orange), `office_R_C`
  // (orange) — replacing the original obj1..obj5 LoRA sheets. Each
  // sheet's grid varies in size; see `/sprites.html` (Objects tab)
  // for the visual mapping. Old obj1..obj5_*.png files remain on
  // disk as fallback for any key that didn't get a clean cell match
  // in the new art.
  h_counter:    'office_4_0',     // U-shaped reception desk + monitor
  h_desk:       'desks_0_2',      // canonical: 3rd desk in row 1 of desks.png
  h_chair:      'office_4_2',     // blue office chair
  h_cabinet:    'office_4_3',     // 3-drawer filing cabinet
  h_bulletin:   'office_4_4',     // cork bulletin board with notes
  h_plant:      'plants_1_3',     // ficus / leafy potted plant
  h_water:      'office_5_2',     // blue water cooler
  h_vending:    'office_5_3',     // snack vending machine
  h_bed:        'clinical_0_0',   // hospital bed
  h_equipment:  'clinical_0_4',   // vital monitor on cart
  h_fax:        'admin_0_4',      // fax machine

  // ----- Office / front-of-house ---------------------------------
  h_computer:        'office_5_0', // full desktop PC + keyboard + mouse
  h_printer:         'office_5_1', // printer/copier
  h_armchair:        'office_5_4', // padded blue armchair
  h_kiosk:           'office_2_3', // ATM / kiosk
  h_couch:           'office_0_0', // blue 3-seat couch
  h_bench:           'office_0_1', // green 3-seat bench
  h_side_table:      'office_0_2', // small wood table with brochures
  h_brochure:        'office_0_3', // brochure rack
  h_directory:       'office_1_0', // wayfinding / directory sign
  h_sanitizer:       'office_1_1', // wall-mount sanitizer dispenser
  h_coat_rack:       'office_1_2', // coat tree
  h_trash:           'office_1_3', // step-pedal trash can
  ...
  // Originally obj1 cells with no clean new-sheet equivalent. Kept
  // pointing at the legacy LoRA art so layouts that referenced them
  // don't break visually until we generate new variants.
  ...
  // ----- Clinical / medical --------------------------------------
  h_exam_table:      'clinical_0_1',
  h_iv_stand:        'clinical_0_2',
  h_wheelchair:      'clinical_0_3',
  h_stool:           'clinical_1_0', // blue rolling doctor's stool
  h_bedside:         'clinical_1_1', // wood nightstand with drawer
  h_screen:          'clinical_1_2', // folding privacy screen
  h_supply_cart:     'clinical_1_3',
  h_crash_cart:      'clinical_1_4',
  h_med_cart:        'clinical_2_0',
  h_sink:            'clinical_2_1',
  h_biohazard:       'clinical_2_3',
  h_linen_cart:      'clinical_2_4',
  h_step:            'clinical_3_0', // step stool
  h_gurney:          'clinical_3_2', // wheeled stretcher (2x wide cell)
  h_equip_cart:      'obj3_3_2', // legacy fallback — no clean match

  // ----- Facilities / safety -------------------------------------
  h_cleaning_cart:   'facilities_0_0',
  h_mop_bucket:      'facilities_0_1',
  h_wet_floor:       'facilities_0_2',
  h_bin_cart:        'facilities_0_3',
  h_paper_towels:    'facilities_0_4',
  h_supply_cart_2:   'facilities_1_0',
  h_bin_cart_full:   'facilities_1_1',
  h_biohazard_sm:    'facilities_1_2',
  h_linen_bin:       'facilities_1_3',
  h_elevator:        'facilities_1_4',
  h_aed:             'facilities_2_0',
  h_payphone:        'facilities_2_1',
  h_drink_counter:   'facilities_2_2',
  h_fountain:        'facilities_2_4',
  h_arrow_sign:      'facilities_3_0',
  h_clock_office:    'facilities_3_1',

  // ----- Admin / records -----------------------------------------
  h_bookshelf:       'admin_0_0',
  h_file_cart:       'admin_0_1',
  h_cabinet_open:    'admin_0_2', // full-height filing cabinet
  h_lamp:            'admin_0_3',
  h_kiosk_admin:     'admin_1_0', // touchscreen check-in kiosk
  h_intercom:        'admin_1_1',
  h_pneumatic:       'admin_1_2', // pneumatic-tube station
  h_test_tubes:      'admin_1_3', // sample-tube rack
  h_printer_lab:     'admin_1_4', // bench printer / cash register
  h_med_vending:     'admin_2_0',
  h_reception_admin: 'admin_2_1', // big reception desk with monitor + plant
  h_ticker:          'admin_2_2', // 7-segment LED ticker (NOW SERVING)
  h_paper_stack:     'admin_2_3',
  // Legacy fallbacks — no clean match in the new sheets.
  h_shredder:        'obj5_2_2',
  h_cashbox:         'obj5_2_3',
