...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  body::before {
    ...
    background:
      radial-gradient(ellipse at 20% 20%, rgba(163, 197, 255, 0.04), transparent 50%),
      radial-gradient(ellipse at 80% 80%, rgba(126, 226, 193, 0.04), transparent 50%);
    z-index: 0;
  ...
  .register.waiting-room { background: rgba(163, 197, 255, 0.12); color: #c2d5f6; border: 1px solid #2c3a55; }
  .register-flip {
    margin: 16px 0; padding: 12px 16px;
    border-left: 3px solid #c2d5f6; background: rgba(163, 197, 255, 0.05);
    font-size: 13.5px; overflow: hidden;
  }
  .ripple { width: 100%; height: 2px; margin-bottom: 8px; background: linear-gradient(90deg, transparent, #c2d5f6, transparent); animation: ripple 4s infinite ease-in-out; }
  @keyframes ripple {
  ...
  .claim-annotations { width: 240px; flex-shrink: 0; padding-top: 280px; }
  ...
  .claim-section-h { font-size: 10.5px; text-transform: uppercase; letter-spacing: 0.06em; color: #5a4d2b; margin-bottom: 4px; display: flex; align-items: baseline; gap: 10px; flex-wrap: wrap; }
  .claim-section-h.box23-disputed { color: #a23148; }
  .claim-section-h .term { color: inherit; }
  .claim-section-h .term-icon { background: #5a4d2b; color: var(--paper); }
  ...
  .mod-missing { color: #a23148; font-style: italic; font-weight: 600; }
  ...
  .claim-status { font-size: 10px; text-transform: uppercase; letter-spacing: 0.1em; padding: 2px 8px; border-radius: 3px; }
  .claim-status.disputed { background: rgba(239, 91, 123, 0.15); color: #a23148; border: 1px solid var(--bad); }
  .claim-status.amended { background: rgba(126, 226, 193, 0.15); color: #1a6e52; border: 1px solid var(--good); }
  ...
  .amend-callout {
    ...
    border: 2px solid var(--good); border-radius: 8px; cursor: pointer; color: var(--ink);
    box-shadow: 0 0 0 0 rgba(126, 226, 193, 0.18);
    animation: amend-pulse 4.5s ease-in-out infinite;
    transition: transform 0.15s, box-shadow 0.15s;
  }
  .amend-callout:hover:not(:disabled) { transform: translateX(-3px); box-shadow: 0 4px 16px rgba(126, 226, 193, 0.35); animation: none; }
  ...
  .amend-callout:disabled .amend-callout-arrow { color: var(--ink-dim); }
  ...
  .amend-callout-arrow { font-size: 22px; color: var(--good); font-weight: 700; line-height: 1; flex-shrink: 0; margin-top: 2px; }
  .amend-callout-body { display: flex; flex-direction: column; gap: 4px; flex: 1; }
  .amend-callout-main { font-size: 13px; font-weight: 700; color: var(--good); }
  ...
  .amend-modal { background: var(--panel); border: 1px solid var(--good); border-left-width: 4px; border-radius: 8px; padding: 24px 28px 20px; max-width: 640px; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.5); position: relative; margin: auto; }
  ...
  .amend-tag { font-size: 11px; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; color: var(--good); }
  .amend-sub { font-size: 13px; color: var(--ink-dim); }
  .amend-context { background: var(--panel-2); padding: 10px 14px; border-radius: 5px; font-size: 13px; margin-bottom: 14px; border-left: 3px solid var(--good); }
  ...
  .amend-option:hover { background: #232b3a; border-left-color: var(--good); }
  ...
  .btn.primary:hover:not(.disabled):not(:disabled) { background: #c2d5f6; }
  ...
  .recap { margin-top: 12px; padding: 12px 14px; background: rgba(163, 197, 255, 0.06); border: 1px solid #2c3a55; border-radius: 5px; }
