...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  body::before {
    ...
    background:
      radial-gradient(ellipse at 20% 20%, rgba(177, 139, 214, 0.05), transparent 50%),
      radial-gradient(ellipse at 80% 80%, rgba(239, 91, 123, 0.04), transparent 50%);
    z-index: 0;
  ...
  .claim-annotations { width: 240px; flex-shrink: 0; padding-top: 60px; }
  ...
  .btn.primary:hover:not(.disabled) { background: #d2b3eb; }
  ...
  .recap { margin-top: 12px; padding: 12px 14px; background: rgba(177, 139, 214, 0.06); border: 1px solid #3a324a; border-radius: 5px; }
  ...
  .victory, .defeat { background: var(--panel); border: 1px solid #232a36; border-radius: 8px; padding: 32px 28px; margin: 22px 0 60px; text-align: center; }
  .victory h2, .defeat h2 { font-size: 26px; margin-bottom: 16px; }
  .defeat h2 { color: var(--bad); }
  .victory p, .defeat p { max-width: 560px; margin: 12px auto; }
  .victory .register, .defeat .register { margin-top: 20px; }
  .victory .btn.primary, .defeat .btn.primary { margin-top: 24px; }
  .victory .back-link.inline, .defeat .back-link.inline { display: block; margin-top: 16px; font-size: 12px; }
